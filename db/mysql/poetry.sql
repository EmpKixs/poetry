...
CREATE TABLE `article`  (
    ...
    `book_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '典籍ID',
    ...
    `author_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '内容作者ID',
    `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '内容',
    `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '注释',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '古代典籍内容' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book`  (
    ...
    `preface` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '前言/序言',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_author_id`(`author_id`) USING BTREE
